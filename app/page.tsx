import PlasmaLogo from '@/app/ui/plasma-logo';
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal ${lusitana.className}`}>
            <strong>Welcome to <span className="line-through">Acme</span> Plasma.</strong> This is the example for the{' '}
            <a href="https://nextjs.org/learn/" className="text-purple-500">
              Next.js Learn Course
            </a>
            , brought by Vercel and created by <a href="https://github.com/BarbosaKO" target="_blank" className="text-orange-500">Gabriel Barbosa</a>.
          </p>
          <Link
            href="/login"
